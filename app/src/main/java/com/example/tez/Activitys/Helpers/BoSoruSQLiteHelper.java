...
public class BoSoruSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String Icerik = "soru";//colom 3
    private static final String SecenekA = "cvpA";//colom 4
    private static final String SecenekB = "cvpB";//colom 5
    private static final String SecenekC = "cvpC";//colom 6
    private static final String SecenekD = "cvpD";//colom 7
